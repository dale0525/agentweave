...
import com.generalagent.mobile.runtime.AndroidAgentAppAppearanceStore
import com.generalagent.mobile.runtime.AndroidAgentAppLocalizationStore
...
import com.generalagent.mobile.ui.LocalAppStrings
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    setContent {
      ...
      CompositionLocalProvider(LocalAppStrings provides localization.strings(selectedLocaleId)) {
        GeneralAgentTheme(appearance, selectedThemeId) {
