...
pub(crate) enum StoreFaultPoint {
    ...
    ExecutionCopyFile,
    BundlePublisherLockAttempt,
    BundlePublisherLockAcquired,
    BundleBeforeGenerationReservation,
    BundleBeforePublish,
    BundleBeforeGenerationsCleanup,
    BundleBeforeGenerationsCleanupMove,
    BundleBeforeGenerationsCleanupDelete,
    BundleBeforeOutputCleanup,
    BundleBeforeOutputCleanupMove,
    BundleBeforeOutputCleanupDelete,
